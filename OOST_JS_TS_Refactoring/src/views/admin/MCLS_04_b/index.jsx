...
import MCLS_04_b_graph1 from "assets/img/graph/PC부품,PC 검색량.png"
import MCLS_04_b_graph2 from "assets/img/graph/노트북,노트북악세사리.png"
...
// Custom part
import General from "views/admin/MCLS_04_b/components/General";
import Projects from "views/admin/MCLS_04_b/components/Projects";
  ...
  return (
    <div>
      ...
      <SimpleGrid columns={{ base: 2, md: 2, xl: 2 }} gap='20px' mb='20px'  spacing={100}> {/* 반응형 웹 설정 모바일, 태블릿, 데스크탑 순*/}
        ...
        <Graph image={MCLS_04_b_graph1} />
          <Graph image={MCLS_04_b_graph2} />
